# Charles Zhang | OIM 3641 Classwork

Coursework, in-class activities, and projects for **OIM 3641**, organized as a working portfolio of applied data science and analytics.
...
│   └── ...
│
├── projects/               # Larger project work and milestones
│   └── project-name/
...
Each assignment folder contains its own notebook or script plus any data it needs, so every piece of work can run on its own.
